...
import { getSimulationComponent, isSimulationImplemented } from '../components/simulations/SimulationRegistry';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            {(() => {
              const SimulationComponent = getSimulationComponent(simulationSlug);
